...
OUTPUT_DIR = SCRIPT_DIR.parent / "results_archive" / "results_e08_circle_n3_5seeds"
SEEDS = [0, 1, 2, 3, 4]
REPRESENTATIONS = ["raw", "relative"]

print("=" * 68)
print("  Circle experiment: N=3, seeds=0..4, raw vs relative")
...
plot_reward_vs_repr(summary, REPRESENTATIONS, n_list=[3],
                    save_path=str(OUTPUT_DIR / "reward_vs_repr.png"))
plot_collision_rate(summary, REPRESENTATIONS, n_list=[3],
